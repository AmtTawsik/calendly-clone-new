<template>
    <div>
            ...
            <div class="w-full max-w-lg">
                ...
                <section class="bg-white dark:bg-gray-900 w-full">
                    <form action="#" class="space-y-2">
                        <div>
                            <label for="subject"
                                class="block mb-2 text-sm font-bold text-gray-900 dark:text-gray-300">Your
                                Name</label>
                        ...
                        <div class="sm:col-span-2">
                            <label for="message"
                                class="block mb-2 text-sm font-bold text-gray-900 dark:text-gray-400">Please
                                share
        ...
        <div class="px-5 md:px-0 py-10 md:py-2" v-show="currentTab === 3">
            ...
            <p class="text-gray-600 my-3 text-center md:text-left">A calendar invitation has been sent to your email
                address.
            </p>
